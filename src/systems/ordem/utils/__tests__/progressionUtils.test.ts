...
describe('NEX_STEPS', () => {
  it('tem 20 degraus, de 5% a 99% (não 100%)', () => {
    expect(NEX_STEPS).toHaveLength(20)
    expect(NEX_STEPS[0]).toBe(5)
...
describe('getNexIndex', () => {
  it('NEX 5% é o índice 0', () => expect(getNexIndex(5)).toBe(0))
  it('NEX 99% é o índice 19', () => expect(getNexIndex(99)).toBe(19))
})
