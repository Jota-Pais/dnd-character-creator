...
**Fase 13 — ✅ CONCLUÍDA (2026-07-09).** Ocultistas escolhem rituais (por círculo 1º–4º e elemento, limitados pelo Intelecto) nos slots já abertos pela Fase 12 (`Escolhido pelo Outro Lado`) — mesmo padrão de "slot real" já usado. Poderes já saíram completos na Fase 12.

**Fase 14 — ✅ CONCLUÍDA (2026-07-09).** Loadout inicial padrão Recruta (Categoria 0 ilimitada + até 2 de Categoria I, restrito por carga = 5×Força e por proficiência de arma da classe), conforme a decisão de escopo acima — sem simular Patente/PP de campanha.
